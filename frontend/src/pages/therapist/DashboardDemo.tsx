...
import { 
  Calendar, Users, DollarSign, Clock, Bell, Settings, User, 
  MessageSquare, TrendingUp, Star, Phone, Video, FileText,
  ChevronRight, Menu, X, Edit2
} from 'lucide-react';
...
const TherapistDashboard: React.FC = () => {
  ...
  const stats = [
    ...
    { label: 'This Month Revenue', value: '$8,450', change: '+18%', icon: DollarSign, bgColor: 'bg-green-100', textColor: 'text-green-600' },
    ...
    <div className="min-h-screen w-screen bg-gray-50">
      ...
      <div className={`fixed left-0 top-0 h-full w-64 bg-white shadow-xl transform transition-transform duration-300 z-50 ${
        ...
        <div className="flex items-center justify-between p-6 border-b">
          <h2 className="text-xl font-bold text-gray-900">MindCare</h2>
